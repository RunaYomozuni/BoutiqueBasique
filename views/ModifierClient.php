    ...
    if (isset($recherche)) {
        ...
        <section id='section'>
            ...
            <form action='../controllers/Controller.php' method="post" id="formCreate">
                ...
                <div>
                    <label for="clientAncienPassword">Ancien mot de passe</label>
                    <input type="text" name="clientAncienPassword" id="clientPassword">
                </div>
                ...
                <div>
                    <label for="clientConfirmPassword">Comfirme mot de passe</label>
                    <input type="text" name="clientConfirmPassword" id="clientPassword">
                </div>
                <div>
                <div>
